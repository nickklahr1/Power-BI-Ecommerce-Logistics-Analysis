...
Olist experienced explosive year-over-year (YOY) growth, with sales increasing by 34.8 to $7.6 million. However, this rapid scaling is visibly straining our logistics network, resulting in a 4.11% increase in average delivery times.

<img width="1018" height="204" alt="image" src="https://github.com/user-attachments/assets/313abd74-0ebd-45a0-aa12-0bf2699d8788" />

# <ins>Insights Deep Dive</ins>

#### **Sales & Revenue Performance**

*   **Main insight 1.**  Revenue is highly concentrated in a few key product categories. "Bed, Bath & Table", "Watches" (gifts), and "Health & Beauty" are the top performers, making their operational stability critical to the company's bottom line.

     <img width="803" height="540" alt="image" src="https://github.com/user-attachments/assets/2549ae2a-33ca-4beb-abe4-7e80928a5eda" />

#### **Logistics & Delivery Benchmarking**

*   **Main insight 1.** The explosive growth in sales has led to a degradation in delivery performance. The overall average delivery time increased by **4.11%** YOY, indicating that our current logistics infrastructure is struggling to keep pace with demand.
...
#### **State Performance Quadrant Analysis**
...
<p align="center">
   <img width="765" height="429" alt="image" centered="true" src="https://github.com/user-attachments/assets/1af3b040-d44e-4950-8869-5ff1a9c6a9ee" />
</p>
